...
subtests (tasks, watch); `SPRITES_SDK_DEBUG=1` shows which connection mode the SDK used. The
backup suite skips itself unless the daemon under test was started with a reachable
`--backup-bucket`.
